    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (operation) {
                ...
                break;
                case 3: {
                    int tax1 = taxEarningsMinusSpending(earnings, spending);//135 доход минус расход
                    int tax2 = taxEarningsMultiplyPermTax(earnings);//60 доходы
                    int result = tax1 - tax2;//135-60
                    if (tax1 < tax2) {
